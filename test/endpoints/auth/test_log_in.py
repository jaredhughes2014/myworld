...
from app.endpoints.auth import log_in
...
class LogInTestCase(EndpointTestCase):
    ...
    def setUp(self):
        ...
        self.mount_endpoint(log_in, email=self.email, pw=self.pw)
    ...
    def test_standard_behavior(self):
        ...
        self.assert_execute_correct(op, db.authenticate, auth_key, self.email)
