...
from app.endpoints.auth import validate_auth
...
class AuthenticateTestCase(EndpointTestCase):
    ...
    def setUp(self):
        ...
        self.mount_endpoint(validate_auth, key=self.auth_key, email=self.email)
    ...
    def test_standard_behavior(self):
        ...
        self.assert_execute_correct(op, db.validate_auth, self.auth_key, self.email)
